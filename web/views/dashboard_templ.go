...
func HeroSection(props HeroProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/views/dashboard.templ`, Line: 102, Col: 89}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/views/dashboard.templ`, Line: 135, Col: 84}
		}
...
func ServersSection() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "<section class=\"glass-panel servers-section\" data-component=\"servers\" role=\"region\" aria-label=\"Remote server metrics\" data-dashboard-section data-section-id=\"servers\"><button class=\"section-handle\" type=\"button\" data-section-handle aria-label=\"Drag servers section\" draggable=\"true\"><i class=\"fas fa-grip-vertical\"></i></button><div class=\"servers-header\"><div><div class=\"servers-title\">Remote Servers</div><div class=\"servers-meta\">Latest health signals from configured servers</div></div><div class=\"servers-summary\" id=\"serverMetricsSummary\">-- tracked</div></div><div class=\"servers-grid\" id=\"serverMetricsList\"><div class=\"servers-empty\" id=\"serverMetricsEmpty\">Server metrics will appear here soon</div></div></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func HeartbeatSection() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "<section class=\"glass-panel heartbeat-section\" data-component=\"heartbeats\" role=\"region\" aria-label=\"Server heartbeat status\" data-dashboard-section data-section-id=\"heartbeats\"><button class=\"section-handle\" type=\"button\" data-section-handle aria-label=\"Drag heartbeats section\" draggable=\"true\"><i class=\"fas fa-grip-vertical\"></i></button><div class=\"heartbeat-header\"><div><div class=\"heartbeat-title\">Domain Heartbeat</div><div class=\"heartbeat-meta\">Live status across configured targets</div></div><div class=\"heartbeat-meta\" id=\"heartbeatSummary\">-- online / -- total</div></div><div class=\"heartbeat-controls\"><input type=\"text\" class=\"heartbeat-search\" id=\"heartbeatSearch\" placeholder=\"Search servers...\" aria-label=\"Search heartbeat targets\"></div><div class=\"heartbeat-grid\" id=\"heartbeatList\"><div class=\"heartbeat-empty\">No heartbeat data yet</div></div></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
