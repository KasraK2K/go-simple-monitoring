...
func ServersSection() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "<section class=\"section-block servers-section\" data-component=\"servers\" role=\"region\" aria-label=\"Remote server metrics\" data-dashboard-section data-section-id=\"servers\"><button class=\"section-handle\" type=\"button\" data-section-handle aria-label=\"Drag servers section\" draggable=\"true\"><i class=\"fas fa-grip-vertical\"></i></button><div class=\"section-heading servers-heading\"><div class=\"section-title\"><span class=\"section-badge\">Remote Servers</span><h2>Distributed Health</h2></div><div class=\"servers-summary\" id=\"serverMetricsSummary\">-- tracked</div></div><div class=\"servers-grid\" id=\"serverMetricsList\"><div class=\"servers-empty\" id=\"serverMetricsEmpty\">Server metrics will appear here soon</div></div></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
